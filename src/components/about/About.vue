<template>
  <div
    class="hero flex justify-center flex-col-reverse md:flex-row pt-10"
    :class="getThemeClass(isDarkMode)"
  >
    <div class="content py-5 p-3 md:p-1 md:w-2/5 space-y-8">
      <h1
        class="pe-10 md:pe-24 text-4xl w-full md:text-5xl font-bold"
      ...
      <div class="pe-10 md:pe-24 flex flex-col">
        <p>
          I've been making computers do my bidding for over 15 years. I've done
          everything from designing websites to building the servers they run
          on. These days my passion is building web applications with Laravel,
          Vue, and Tailwind.
        </p>
    ...
    <div class="image p-10 md:p-1 md:w-1/5">
      <img
        class="rounded-md opacity-70 hover:opacity-100"
